		...
		<div class="col-xl-10 col-lg-12 col-md-9">
			...
			<div class="card o-hidden border-0 shadow-lg my-5">
				<div class="card-body p-0">
					...
					<div class="row">
<!-- 						<div class="col-lg-6S d-none d-lg-block bg-login-image"></div> -->
						<div class="col-lg-12">
							<div class="p-5">
								<div class="text-center">
									<h1 class="h4 text-gray-900 mb-4">Mega Value Innovator in Entertainment</h1>
								</div>
								<form class="user">
									...
									<div class="form-group">
										<div class="custom-control custom-checkbox small">
											<input type="checkbox" class="custom-control-input" id="rememberId"> <label class="custom-control-label" for="rememberId">Remember ID</label>
										</div>
										<div class="custom-control custom-checkbox small">
											<input type="checkbox" class="custom-control-input" id="rememberPasswd"> <label class="custom-control-label" for="rememberPasswd">Remember PWD</label>
										</div>
									</div>
