...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-xl-3 col-md-6 mb-4">
			<div class="card border-left-primary shadow h-101 py-2">
				<div class="card-body">
		...
		<div class="col-xl-3 col-md-6 mb-4">
			<div class="card border-left-success shadow h-101 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
		...
		<!-- Task Card Example -->
		<div class="col-xl-3 col-md-6 mb-4">
			<div class="card border-left-info shadow h-101 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
		...
		<div class="col-xl-3 col-md-6 mb-4">
			<div class="card border-left-warning shadow h-101 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
	...
	<div class="row">
		...
		<div class="col-lg-6 mb-4">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<p>Smile Q makes extensive use of Bootstrap 4 utility classes in order to reduce CSS bloat and poor page performance. Custom CSS classes are used to create custom components and custom utility classes.</p>
...
<script type="text/javascript" src="/webjars/chartjs/Chart.min.js"></script>
<script type="text/javascript" src="/resources/js/demo/chart-area-demo.js"></script>
<script type="text/javascript" src="/resources/js/demo/chart-pie-demo.js"></script>
