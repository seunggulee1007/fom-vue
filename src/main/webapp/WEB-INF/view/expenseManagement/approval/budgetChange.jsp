...
<div id="container" class="container container--include-lnb container--fullview container--iframe">
    <h2 class="page-title">예산변경신청</h2>
    <!-- <p class="page-title__dsc">· 예산변경신청을 할 수 있는 페이지입니다.</p> -->
    ...
    <div class="grid-layout">
        <div class="grid-column10">
            <iframe src="http://ekp.smilegate.net/eNovator/GSWF/WebPage/ApprovalForms/ApprovalFormCtrl.aspx?formID=318" frameborder="0"></iframe>
        </div>
    </div>
</div>