...
<div id="container" class="container container--include-lnb container--fullview container--iframe">
    ...
    <h2 class="page-title">기안서</h2>
    <!-- <p class="page-title__dsc">· 기안서를 작성할 수 있는 페이지입니다.</p> -->
    ...
    <div class="grid-layout">
        <div class="grid-column10">
            <iframe src="http://ekp.smilegate.net/eNovator/GSWF/WebPage/ApprovalCost/ApprovalCostMainWriteCross.aspx" frameborder="0"></iframe>
        </div>
    </div>
</div>