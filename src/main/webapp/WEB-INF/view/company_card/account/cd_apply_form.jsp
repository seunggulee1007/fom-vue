...
<div id="container" class="container container--include-lnb container--fullview container--iframe">
    <h2 class="page-title">공용카드 신청서</h2>
    <!-- <p class="page-title__dsc">· 공용카드 신청 페이지입니다.</p> -->
    ...
    <div class="grid-layout">
        <div class="grid-column10">
            <iframe src="http://ekp.smilegate.net/eNovator/GSWF/WebPage/ApprovalForms/ApprovalFormCtrl.aspx?formID=97" frameborder="0"></iframe>
        </div>
    </div>
</div>