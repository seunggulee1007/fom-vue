...
<div id="container" class="container container--include-lnb container--fullview container--iframe">
    <h2 class="page-title">카드메일발송</h2>
    <!-- <p class="page-title__dsc">· 카드 메일을 발송할 수 있는 페이지입니다.</p> -->
    ...
    <div class="grid-layout">
        <div class="grid-column10">
            <iframe src="http://bi.smilegate.net/eNovatorSGData/SMILENET/SendMail_Write.aspx" frameborder="0"></iframe>
        </div>
    </div>
</div>