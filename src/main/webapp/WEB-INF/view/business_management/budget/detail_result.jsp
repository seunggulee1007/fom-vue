...
<div id="container" class="container container--include-lnb container--fullview container--iframe">
    ...
    <h2 class="page-title">실적 상세내역</h2>            
    ...
    <div class="grid-layout">
        <div class="grid-column10">
            <iframe src="http://sgma.smilegate.net/erpma/budget/resultMoniteringPortal" frameborder="0"></iframe>
        </div>
    </div>
</div>
                    ...
                    <div class="popup__contents popup__contents-inner-wrap">
                        ...
                        <div class="popup__contents-inner">
                            ...
                            <ul class="popup__lst">
                                ...
                                <li class="popup__lst-item">
                                    <a href="detail_result.html" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">비용 계획/실적 조회</span></a>
                                    <ul class="popup__lst-sub">
                                        <li class="popup__lst-sub-item">
                                            <a href="detail_result.html" class="popup__lst-sub-menu">
                                                <span class="popup__contents-txt popup__lst-sub-menu-txt">실적 상세내역</span>
                                            </a>
                                        </li>
                                        <li class="popup__lst-sub-item">
                                            <a href="plan_result.html" class="popup__lst-sub-menu">
