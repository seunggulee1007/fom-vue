...
<div class="lnb lnb-area">
    <ul class="lst-lnb">
        <li class="lst-lnb__item <c:if test="${URI eq '/financial_link/tax_schedule' }"> lst-lnb__item--active</c:if>">
            <a href="/financial_link/tax_schedule" class="lst-lnb__menu">
                <span class="lst-lnb__menu-txt">월별 세무 일정</span>
            </a>
        </li>
        <li class="lst-lnb__item <c:if test="${URI eq '/financial_link/exchange' }"> lst-lnb__item--active</c:if>">
            <a href="/financial_link/exchange" class="lst-lnb__menu">
        ...
        <li class="lst-lnb__item">
            ...
            <ul class="lst-lnb-sub">
                <li class="lst-lnb-sub__item <c:if test="${URI eq '/financial_link/biz_chk/biz_num' }"> lst-lnb-sub__item--active </c:if>">
                    <a href="/financial_link/biz_chk/biz_num" class="lst-lnb-sub__menu">
                        <span class="lst-lnb-sub__menu-txt">거래처 휴/폐업 조회</span>
                    </a>
                </li>
                <li class="lst-lnb-sub__item <c:if test="${URI eq '/financial_link/biz_chk/biz_chk_history' }"> lst-lnb-sub__item--active</c:if>">
                    <a href="/financial_link/biz_chk/biz_chk_history" class="lst-lnb-sub__menu">
