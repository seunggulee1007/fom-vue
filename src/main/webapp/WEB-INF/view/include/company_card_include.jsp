...
<div class="lnb lnb-area">
    <ul class="lst-lnb">
        <li class="lst-lnb__item lst-lnb__item--active">
            ...
            <ul class="lst-lnb-sub">
                <li class="lst-lnb-sub__item">
                    <a href="/company_card/account/cd_apply_form" class="lst-lnb-sub__menu">
                        <span class="lst-lnb-sub__menu-txt">공용카드 신청서</span>
                    </a>
                </li>
                <li class="lst-lnb-sub__item">
                    <a href="/company_card/account/com_cd_form" class="lst-lnb-sub__menu">
                        <span class="lst-lnb-sub__menu-txt">법인카드 신청서</span>    
                    </a>                                
                </li>                            
                <li class="lst-lnb-sub__item">
                    <a href="/company_card/account/change_limit" class="lst-lnb-sub__menu">
                        <span class="lst-lnb-sub__menu-txt">카드한도 증액신청</span>
                    </a>
                </li>
                <li class="lst-lnb-sub__item  lst-lnb-sub__item--active">
                    <a href="/company_card/account/account_info" class="lst-lnb-sub__menu">
        ...
        <li class="lst-lnb__item">
            ...
            <ul class="lst-lnb-sub">
                <li class="lst-lnb-sub__item">
                    <a href="/company_card/managing/com_limit" class="lst-lnb-sub__menu">
                        <span class="lst-lnb-sub__menu-txt">법인별 월한도</span>    
                    </a>
                </li>
                <li class="lst-lnb-sub__item">
                    <a href="/company_card/managing/user_limit" class="lst-lnb-sub__menu">
                        <span class="lst-lnb-sub__menu-txt">사용자별 한도</span>    
                    </a>
                </li>
                <li class="lst-lnb-sub__item">
                    <a href="/company_card/managing/limit_management" class="lst-lnb-sub__menu">
                        <span class="lst-lnb-sub__menu-txt">카드한도관리</span>    
                    </a>
                </li>
                <li class="lst-lnb-sub__item">
                    <a href="/company_card/managing/send_mail" class="lst-lnb-sub__menu">
                        <span class="lst-lnb-sub__menu-txt">카드메일발송</span>    
                    </a>
                </li>
                <li class="lst-lnb-sub__item">
                    <a href="/company_card/managing/list_mail" class="lst-lnb-sub__menu">
