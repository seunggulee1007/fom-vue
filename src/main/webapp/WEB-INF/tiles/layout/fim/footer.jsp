            ...
            <div class="popup__inner-wrap clearfix">
                ...
                <div class="popup__contents popup__contents-inner-wrap">
                    ...
                    <div class="popup__contents-inner">
                        ...
                        <ul class="popup__lst">
                            <li class="popup__lst-item">
                                <a href="/company_card/account/approval_form" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">카드 신청/정산 처리</span></a>
                                <ul class="popup__lst-sub">
                                    <li class="popup__lst-sub-item">
                                        <a href="/company_card/account/cd_apply_form" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">공용카드 신청서</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/company_card/account/com_cd_form"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">법인카드 신청서</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/company_card/account/change_limit"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">카드한도 증액신청</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/company_card/account/account_info" class="popup__lst-sub-menu">
                            ...
                            <li class="popup__lst-item">
                                <a href="/company_card/managing/com_limit" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">카드 한도 관리</span></a>
                                <ul class="popup__lst-sub">
                                    <li class="popup__lst-sub-item">
                                        <a href="/company_card/managing/com_limit" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">법인별 월한도</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/company_card/managing/user_limit"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">사용자별 한도</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/company_card/managing/limit_management"  class="popup__lst-sub-menu" target="_blank">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">카드한도 관리</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="company_card/managing/send_mail"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">카드메일발송</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/company_card/managing/list_mail"  class="popup__lst-sub-menu">
                    ...
                    <div class="popup__contents-inner">
                        ...
                        <ul class="popup__lst">
                            <li class="popup__lst-item">
                                <a href="/expense_management/approval/approval_form" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">전자결재</span></a>
                                <ul class="popup__lst-sub">
                                    <li class="popup__lst-sub-item">
                                        <a href="/expense_management/approval/approval_form" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">기안서</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/expense_management/approval/approval_report"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">기안서(보고)</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/expense_management/approval/expense" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">지출결의서</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/expense_management/approval/budget_change"  class="popup__lst-sub-menu">
                            ...
                            <li class="popup__lst-item">
                                <a href="/expense_management/bill/tax_bill" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">전자세금계산서</span></a>
                                <ul class="popup__lst-sub">
                                    <li class="popup__lst-sub-item">
                                        <a href="/expense_management/bill/tax_bill" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">전자세금계산서</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/expense_management/bill/bill"  class="popup__lst-sub-menu">
                            ...
                            <li class="popup__lst-item">
                                <a href="/expense_management/workshop" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">워크샵 신청/정산</span></a>
                            </li>
                            <li class="popup__lst-item">
                                <a href="/expense_management/cafeteria" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">중석식 정산</span></a>
                            </li>
                            <li class="popup__lst-item">
                                <a href="/expense_management/cafeteria_mobile" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">모바일식권 정산</span></a>
                            </li>
                            <li class="popup__lst-item">
                                <a href="/expense_management/advance_payment" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">전도금 정산</span></a>
                            </li>
                            <li class="popup__lst-item">
                                <a href="/expense_management/taxi" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">택시비 정산</span></a>
                            </li>
                        </ul>
                    </div>  
                    <div class="popup__contents-inner">
                        ...
                        <ul class="popup__lst">
                            <li class="popup__lst-item">
                                <a href="/business_management/eis/select_month_report" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">프로젝트 손익조회</span></a>
                                <ul class="popup__lst-sub">
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/eis/select_month_report" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">당월손익</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/eis/monthly_report"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">월별손익</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/eis/accumulation"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">누적손익</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/eis/current_pjt" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">프로젝트 현황</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/eis/current_profit" class="popup__lst-sub-menu">
                            ...
                            <li class="popup__lst-item">
                                <a href="/business_management/budget/detail_result" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">비용 계획/실적 조회</span></a>
                                <ul class="popup__lst-sub">
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/budget/detail_result" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">실적 상세내역</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/budget/plan_result" class="popup__lst-sub-menu">
                            ...
                            <li class="popup__lst-item">
                                <a href="/business_management/work/user_schedule" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">업무 투입율</span></a>
                                <ul class="popup__lst-sub">
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/work/user_schedule" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">업무 투입 시간</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/work/user_ratio" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">나의 투입률 관리</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/work/dept_ratio"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">부서 투입률 관리</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/work/dept_mng" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">부서/프로젝트 관리</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/work/all_mng"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">전체투입률 관리</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/work/work_history" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">작업내역 관리</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/work/belong_com"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">귀속법인별 MM 집계</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/work/pjt_mm" class="popup__lst-sub-menu">
                            ...
                            <li class="popup__lst-item">
                                <a href="/business_management/cafe" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">비즈카페</span></a>
                            </li>
                            <li class="popup__lst-item">
                                <a href="/business_management/car/car_list" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">차량관리</span></a>
                                <ul class="popup__lst-sub">
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/car/car_list" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">차량목록</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/car/car_drive"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">차량운행일지</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/car/car_confirm"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">차량 비용귀속 확인</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/car/car_costing"  class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">차량 비용산출</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/car/car_cost_system" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">업무용 승용차 명세서 확인</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/business_management/car/car_cost_no_drive" class="popup__lst-sub-menu">
                    ...
                    <div class="popup__contents-inner">
                        ...
                        <ul class="popup__lst">
                            <li class="popup__lst-item">
                                <a href="/portal_management/info" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">공지사항</span></a>
                            </li>                                                                        
                            <li class="popup__lst-item">
                                <a href="/portal_management/approval_pending" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">전자결재 - 미결함</span></a>
                            </li>                                    
                            <li class="popup__lst-item">
                                <a href="/portal_management/approval_pre" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">전자결재 - 예정함</span></a>
                            </li>
                            <li class="popup__lst-item">
                                <a href="/portal_management/approval_progress" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">전자결재 - 진행함</span></a>
                            </li>
                        </ul>
                    </div>  
                    <div class="popup__contents-inner">
                        ...
                        <ul class="popup__lst">
                            <li class="popup__lst-item">
                                <a href="/mng_info/mng_group" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">Group</span></a>
                            </li>
                            <li class="popup__lst-item">
                                <a href="/mng_info/mng_company" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">Company</span></a>
                            </li>
                            <li class="popup__lst-item">
                                <a href="/mng_info/mng_executives" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">Executives</span></a>
                            </li>
                        </ul>
                    </div>
                    <div class="popup__contents-inner">
                        ...
                        <ul class="popup__lst">
                            <li class="popup__lst-item">
                                <a href="/financial_link/tax_schedule" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">월별 세무 일정</span></a>
                            </li>
                            <li class="popup__lst-item">
                                <a href="/financial_link/exchange" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">환율 정보</span></a>
                            </li>
                            <li class="popup__lst-item">
                                <a href="/financial_link/biz_chk/biz_num" class="popup__lst-menu"><span class="popup__contents-txt popup__lst-item-txt">거래처 휴/폐업 조회</span></a>
                                <ul class="popup__lst-sub">
                                    <li class="popup__lst-sub-item">
                                        <a href="/financial_link/biz_chk/biz_num" class="popup__lst-sub-menu">
                                            <span class="popup__contents-txt popup__lst-sub-menu-txt">거래처 휴/폐업 조회</span>
                                        </a>
                                    </li>
                                    <li class="popup__lst-sub-item">
                                        <a href="/financial_link/biz_chk/biz_chk_history"  class="popup__lst-sub-menu">
